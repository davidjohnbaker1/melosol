...
The title _MeloSol_ derives from a combination of the corpus' content-- _Mel_ odic data-- and the first name of the original author of the collection, _Sol_ Berkowitz.
